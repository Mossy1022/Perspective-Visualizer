...
import nuclearVsRenewable from '../seed_canvases/nuclear_vs_renewable.json';
import relationship from '../seed_canvases/relationship_commitment.json';
...
usePerspectiveStore.getState().setSnapshot(
  relationship as unknown as PerspectiveSnapshot
  );
